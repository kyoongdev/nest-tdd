...
export class Migration1683779894750 implements MigrationInterface {
  name = 'Migration1683779894750';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`id\``);
    await queryRunner.query(
      `ALTER TABLE \`user\` ADD \`id\` varchar(36) NOT NULL`,
    );
    ...
    await queryRunner.query(`ALTER TABLE \`post\` DROP COLUMN \`id\``);
    await queryRunner.query(
      `ALTER TABLE \`post\` ADD \`id\` varchar(36) NOT NULL`,
    );
